...
public class HalamanMinuman {
    public HalamanMinuman() {
        JFrame frame = new JFrame("Halaman Minuman");
        ...
        // Label Header
        JLabel titleLabel = new JLabel("Minuman", SwingConstants.CENTER);
        ...
        ArrayList<Minuman> minumanList = MinumanTable.getAllMinuman();
        for (Minuman minuman : minumanList) {
            ...
            minumanPanel.setPreferredSize(new Dimension(200, 250));
            minumanPanel.setOpaque(false);
            // Menambahkan border melengkung
            minumanPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
            ...
            JLabel gambarLabel = new JLabel() {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    ImageIcon icon = new ImageIcon(minuman.getGambarPath());
            ...
            minumanPanel.add(gambarPanel, BorderLayout.NORTH);

            // Nama dan Deskripsi
            JLabel namaLabel = new JLabel(minuman.getNama(), SwingConstants.CENTER);
            namaLabel.setFont(new Font("Arial", Font.BOLD, 16));
            JLabel deskripsiLabel = new JLabel("<html><center>" + minuman.getDeskripsi() + "</center></html>", SwingConstants.CENTER);
            ...
            minumanPanel.add(textPanel, BorderLayout.CENTER);
            ...
            JLabel hargaLabel = new JLabel(" Rp " + minuman.getHarga(), SwingConstants.LEFT);
            ...
            minumanPanel.add(bottomPanel, BorderLayout.SOUTH);

            // Tambahkan makananPanel ke contentPanel
            contentPanel.add(minumanPanel);
