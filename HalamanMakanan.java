...
public class HalamanMakanan {
    public HalamanMakanan() {
        JFrame frame = new JFrame("Halaman Makanan");
        ...
        ArrayList<Makanan> makananList = MakananTable.getAllMakanan();
        for (Makanan makanan : makananList) {
            ...
            makananPanel.setPreferredSize(new Dimension(200, 250));
            makananPanel.setOpaque(false);
            // Menambahkan border melengkung
            makananPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
            ...
            JLabel gambarLabel = new JLabel() {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    ImageIcon icon = new ImageIcon(makanan.getGambarPath());
            ...
            makananPanel.add(gambarPanel, BorderLayout.NORTH);

            // Nama dan Deskripsi
            JLabel namaLabel = new JLabel(makanan.getNama(), SwingConstants.CENTER);
            namaLabel.setFont(new Font("Arial", Font.BOLD, 16));
            JLabel deskripsiLabel = new JLabel("<html><center>" + makanan.getDeskripsi() + "</center></html>", SwingConstants.CENTER);
            ...
            makananPanel.add(textPanel, BorderLayout.CENTER);
            ...
            JLabel hargaLabel = new JLabel(" Rp " + makanan.getHarga(), SwingConstants.LEFT);
            ...
            makananPanel.add(bottomPanel, BorderLayout.SOUTH);

            // Tambahkan makananPanel ke contentPanel
            contentPanel.add(makananPanel);
